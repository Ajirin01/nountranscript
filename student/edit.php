...
<form class="form-horizontal well span9" action="controller.php?action=edit&id=<?php echo $cur->IDNO; ?>" method="POST">
    ...
    <fieldset>
        ...
        <div class="form-group" id="idno">
            ...
            <div class="col-md-8">
                <label class="col-md-8 control-label" for="gender">Admisision Status:* </label>

                <div class="col-md-4">
                    <select class="form-control input-sm" name="admission_status" id="admission_status">
                        <option value="pending">Pending</option>
                        <option value="student">Comfirm</option>
        ...
        <div class="form-group">
            <div class="rows">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <input class="form-control input-sm" id="fName" name="fName" type="text"
                            placeholder="First Name" value="<?php echo $cur->FNAME; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <input class="form-control input-sm" id="mName" name="mName" type="text"
                            placeholder="Middle Name" value="<?php echo $cur->MNAME; ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="rows">
                <div class="col-md-8">
                    ...
                    <div class="col-md-10">
                        <input class="form-control input-sm" id="home" name="home" type="text"
                            placeholder="Home Address" value="<?php echo $cur->HOME_ADD; ?>">
                    </div>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="natid" name="natid" placeholder="National Id" type="text"
                        value="<?php echo $cur->NATIONALITY ; ?>">
                </div>
            </div>
        </div>
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="rows">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <input class="form-control input-sm" id="fOccu" name="fOccu" type="text"
                            placeholder="Occupation" value="<?php echo $det->FATHER_OCCU; ?>">
                    </div>
                </div>
        ...
        <div class="form-group">
            <div class="rows">
                <div class="col-md-6">
                    <label class="col-md-4 control-label" for="boarding">Are you Boarding? </label>
        ...
        <div class="form-group">
            <div class="rows">
                <div class="col-md-6">
                    <label class="col-md-6 control-label" for="otherperson">Other person Supporting </label>
