...
?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Registered Courses by the Student
            </h3>
        </div>
            ...
            <div class="row">
                <div class="container">
                    <div class="well">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p><b>ID Number :
                                                ...
                                                <b>Semester:</b>
                                                <?php echo (isset($sy)) ? $sy->SEMESTER : 'COURSE' ;?><br />
                        ...
                        <a href="index.php?page=8&cid=<?php echo $_GET['cid'];?>&sy=<?php echo $_GET['sy'];?>&SY=<?php echo $_GET['SY'];?>&studentId=<?php  echo (isset($_GET['studentId'])) ? $_SESSION['IDNO'] : 'ID' ; ?>"
                            class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>Register New
                            Course(s)</a>
                        <!--  <button type="submit" class="btn btn-default" name="delete"><span class="glyphicon glyphicon-trash"></span> Delete Selected</button>
				  </form>
					  </body>
