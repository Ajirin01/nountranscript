...
<form class="form-horizontal col-12 span6" action="controller.php?action=edit&id=<?php echo $facultyid;?>"
    method="POST">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    ...
                    <input class="form-control input-sm" id="facultyname" name="facultyname" placeholder="Faculty Name"
                        type="text" value="<?php echo $object->FACULTY_NAME;?>">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="faculty_description" name="faculty_description"
                        placeholder="Faculty Description" type="text" value="<?php echo $object->FACULTY_DESC;?>">
                </div>
            </div>
        </div>
        <div class="form-group">
